...
interface BulkAddModalProps {
    ...
    kaatBasis: KaatBasis;
    kaatRate: number;
    /** Pre-seed the modal for re-categorising an existing bulk item */
    initialMode?: "quick" | "categorize";
    initialWeight?: number;
    initialCarat?: number;
    /** Title shown when categorising an existing item */
    ...
    return (
        <div style={{
            ...
            <div className="card animate-scale-in" style={{
                width: mode === "categorize" ? "min(1000px, 96vw)" : "min(560px, 96vw)",
                maxHeight: "92vh",
                ...
                {mode === "categorize" && (
                    <>
                        {/* Bulk header */}
                        <div style={{ padding: "12px 18px", background: "var(--cream-light)", borderBottom: "1px solid var(--border)", flexShrink: 0 }}>
                        ...
                        {/* Allocation tracker */}
                        <div style={{ padding: "10px 18px", background: "white", borderBottom: "1px solid var(--border)", flexShrink: 0 }}>
